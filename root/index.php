                        ...
                        <tr class="<?php echo $class ?>">
                            ...
                            */
                            ...
                            <td>
                                ...
                                <a id="modal-<?php echo $key ?>" href="#modal-container-<?php echo $key ?>"
                                   role="button" class="btn" data-toggle="modal">View</a>

                                <div class="modal fade in" id="modal-container-<?php echo $key ?>" role="dialog"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <textarea class="form-control" rows='1'
                                                          cols='85'><?php echo $url ?></textarea></br>

                                                <textarea class="form-control" rows='7'
                                                          cols='85'><?php echo $row['request'] ?></textarea><br>
                                                <textarea class="form-control" rows='7'
                                                          cols='85'><?php echo $data ?></textarea><br>
