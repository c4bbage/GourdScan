    ...
    <div class="row">
        <div class="col-md-12">
            <nav class="navbar navbar-default" role="navigation">
                <div class="navbar-header">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="navbar-brand" data-toggle="dropdown">GourdScan<strong
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Action<strong
                                    class="caret"></strong></a>
                            <ul class="dropdown-menu">
                                <li>
                ...
                <form action="" method='POST'>
                    <tr class='warning'>
                        <td>
                            ...
                            <center>
                                <a href="config.php#?action=startproxy" type='submit' disable="true"
                                   class="btn btn-default" value="Add.....">开启代理</a>
                                <a href="config.php#?action=stopproxy" type='submit' class="btn btn-default"
                                   value="Add.....">关闭代理</a>
                                <a href="config.php#?action=startupdate" type='submit' class="btn btn-default"
                                   value="Add.....">关闭自动更新</a>
                                <a href="config.php#?action=stopupdate" type='submit' class="btn btn-default"
                                   value="Add.....">开启自动更新</a>
                            </center>
                        </td>
            ...
            <table class="table">
                ...
                <?php
                $userhash = mysqli_query($conn,"select DISTINCT userhash from sqlmap");
                while ($user = mysqli_fetch_array($userhash)){

                $rows = mysqli_query($conn,"select (select count(*) from sqlmap where userhash='{$user['userhash']}') as allcount,
                    ...
                    <form action="" method='POST'>
                        <tr class='warning'>
                            ...
                            <td>
                                ...
                                <textarea class="form-control" name="key" rows='1'
                                          cols='85'><?php echo $row['key']; ?></textarea>
                            </td>
                            <td>
                                <textarea class="form-control" name="value" rows='1'
                                          cols='85'><?php echo $row['value']; ?></textarea>
